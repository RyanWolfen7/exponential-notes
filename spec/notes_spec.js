...
console.log('should have note one')
expect(html).toHaveContent('<h3>Note one</h3>')
console.log('should have note two')
expect(html).toHaveContent('<h3>Note two</h3>')
console.log('should have note three')
...
console.log('delete functionality should work')
notePad.deleteNote(2)
indexPage = new IndexPage()
html = indexPage.render(notePad.listNotes())
expect(html).toNotHaveContent('<h3>Note three</h3>')
